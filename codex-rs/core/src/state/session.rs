...
use crate::session::research_context::ResearchTaskContext;
use crate::session::session::SessionConfiguration;
use crate::session::time_reminder::CurrentTimeReminderState;
use crate::session_startup_prewarm::SessionStartupPrewarmHandle;
use super::workflow_runtime::WorkflowRuntimeState;
...
pub(crate) struct SessionState {
    ...
    pub(crate) workflow_runtime: WorkflowRuntimeState,
    pub(crate) latest_rate_limits: Option<RateLimitSnapshot>,
    pub(crate) server_reasoning_included: bool,
    pub(crate) mcp_dependency_prompted: HashSet<String>,
    pub(crate) additional_context: AdditionalContextStore,
    pub(crate) research_state: ResearchState,
    pub(crate) research_project_revision: u64,
    pub(crate) research_task_context: ResearchTaskContext,
...
impl SessionState {
    ...
    pub(crate) fn new_with_auto_compact_window_ids(
        ...
        Self {
            session_configuration,
            history,
            workflow_runtime: WorkflowRuntimeState::default(),
            latest_rate_limits: None,
            server_reasoning_included: false,
            mcp_dependency_prompted: HashSet::new(),
            additional_context: AdditionalContextStore::default(),
            research_state: ResearchState::default(),
            research_project_revision: 0,
            research_task_context: ResearchTaskContext::default(),
