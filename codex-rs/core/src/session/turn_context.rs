...
pub struct TurnContext {
    ...
    pub(crate) collaboration_surface_policy: codex_extension_api::CollaborationSurfacePolicy,
...
impl TurnContext {
    ...
    pub(crate) async fn with_model(
        ...
        Self {
            ...
            collaboration_surface_policy: self.collaboration_surface_policy,
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        collaboration_surface_policy: codex_extension_api::CollaborationSurfacePolicy,
    ...
    async fn new_turn_context_from_configuration(
        ...
        let mut turn_context: TurnContext = Self::make_turn_context(
            ...
            &session_configuration,
            multi_agent_version,
            self.services.extensions.collaboration_surface_policy(
